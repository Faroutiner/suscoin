...
"""Verify that starting suscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start suscoin with -h for help text")
        ...
        self.log.info("Start suscoin with -version for version information")
        ...
        self.log.info("Start suscoind with -fakearg to make sure it does not start")
