...
const char * const BITCOIN_CONF_FILENAME = "suscoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Suscoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Suscoin";
#else
    // Unix
    return pathRet / ".suscoin";
#endif
#endif
}
