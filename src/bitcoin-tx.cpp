...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " suscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  suscoin-tx [options] <hex-tx> [commands]  Update hex-encoded suscoin transaction\n" +
            "or:     suscoin-tx [options] -create [commands]   Create hex-encoded suscoin transaction\n" +
            "\n";
