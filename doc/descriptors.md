# Support for Output Descriptors in Suscoin Core

Since Suscoin Core v0.17, there is support for Output Descriptors. This is a
...
on Suscoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Suscoin Core wallets, a convenience function `combo` is
